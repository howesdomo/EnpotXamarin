...
namespace MAMapKit
{
    ...
    public enum MALineJoinType : ulong
    {
        Bevel,
        Miter,
        Round
    ...
    public enum MALineCapType : ulong
    {
        Butt,
        Square,
        Arrow,
    ...
    {
        None = 0,//MAOfflineItemStatusNone,
        Cached = 1,//MAOfflineItemStatusCached,
        Installed = 2,//MAOfflineItemStatusInstalled,
        Expired = 3//MAOfflineItemStatusExpired
    }
